...
if(!isset($_POST['nom']) && !isset($_POST['prenom'])){
	...
	$erreur = verifier_arguments(array('nom','prenom'));

	if( isset($_POST['is_karateka']) ){
		$erreur.= verifier_arguments(array('poids','taille','ceinture'));
		if($_POST['ceinture'] == 'black'){
			$erreur.= verifier_arguments(array('dans'));
		} else {
			$_POST['dans'] == 0;
		}
		...
		$erreur .= verifier_arguments(array('email','tel')) ;
	} else {
